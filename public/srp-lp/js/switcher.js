...
jQuery(document).ready(function($) {
		...
		$("#style-switcher .aqua" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-aqua.css" );
			return false;
		});
	
		$("#style-switcher .green_switcher" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-green.css" );
			return false;
		});
		
		$("#style-switcher .orange" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-orange.css" );
			return false;
		});
		...
		$("#style-switcher .beige" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-beige.css" );
			return false;
		});
		
		$("#style-switcher .gray" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-gray.css" );
			return false;
		});
	
		$("#style-switcher .green-2" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-green-2.css" );
			return false;
		});
		
		$("#style-switcher .navy" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-navy.css" );
			return false;
		});
		...
		$("#style-switcher .purple" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-purple.css" );
			return false;
		});
	
		$("#style-switcher .red" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-red.css" );
			return false;
		});
	
		$("#style-switcher .violet" ).click(function(){
			$("#colors" ).attr("href", "/apply-addmission/css/color-violet.css" );
			return false;
		});
