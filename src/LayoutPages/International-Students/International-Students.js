...
import Datas from '../../data/ResearchAtGlance/ResearchAtGlance.json'
            ...
            <div class="row align-items-center mb-5 pb-md-5">
              <div class="col-lg-6">
                <div class="admission-img mr-15">
                  <img src="assets/images/admission.jpg" alt="Imagu" />
                </div>
              </div>
                ...
                <div className="researchImage">
                  <img
                    src={
                      ...
                      `/assets/images/international-adv.jpg`
                    }
                ...
                <Slider {...settings}>
                  {
                    <div className="teamSlider">
                      <div className="team-item">
                        <img
                          src="https://staging.shooliniuniversity.com/assets/landing/international-students/img/dr.jpeg"
                          alt=""
                          className="img-fluid"
                        />
                        <div className="img-content text-center">
                          <h5>Dr. R. P. Dwivedi</h5>
                          <p>
                            Director, International Affairs and Professor in
                            School of Electrical and Computer Science
                            Engineering Email: rpdwivedi@shooliniuniversity.com
                            Phone: +91-70185-09041
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="team-item">
                        <img
                          src="https://staging.shooliniuniversity.com/assets/landing/international-students/img/dr1.jpg"
                          alt=""
                          className="img-fluid"
                        />
                        <div className="img-content text-center">
                          <h5>Dr. Rozy Dhanta</h5>
                          <p>
                            Assistant Director, International Affairs and
                            Assistant Professor in School of Business Management
                            Email: roseydhanta@shooliniuniversity.com Phone:
                            +91-98166-61810
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="team-item">
                        <img
                          src="https://staging.shooliniuniversity.com/assets/landing/international-students/img/dr2.jpg"
                          alt=""
                          className="img-fluid"
                        />
                        <div className="img-content text-center">
