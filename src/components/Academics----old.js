      ...
      <Styles>
        ...
        <section className="templateHeading highLights">
          <div className="container-fluid p-0">
            <div className="row m-0">
              ...
              <Image width={506} height={435} className="w-100" src="/assets/images/baby2.jpg" />
              </div>
        ...
        >
          <Container>
            ...
            <Row>
              {data.facultylistdetails &&
                data.facultylistdetails.map((i, idx) => {
                  return (
                    <Col md="3" xs="6" key={idx}>
                      <Link
                        href={`/faculty/profile/${i.name.split(' ').join('-')}`}
                        state={{ id: i.id }}
                      >
                        <a>
