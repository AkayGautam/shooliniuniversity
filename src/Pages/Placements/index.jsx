...
import Styless from './style/placements'
      ...
      <Styles>
        ...
        <div className="main-wrapper visionmission-page">
          ...
          <Styless>
                ...
                <div className="row">
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/management/decathlon.png"
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/management/cure.png"
                      />
                    </div>
                  </div>
                ...
                <div className="row">
                  ...
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/engg/lnt.png"
                      />
                    </div>
                  </div>
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                ...
                <div className="row">
                  ...
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/PharmaceuticalSciences/zydu.png"
                      />
                    </div>
                  </div>
            ...
            <section className="content2">
              <div className="container">
                <h2 className="heading">Computer Science</h2>
                <div className="row">
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/CSE/scoreone.png"
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/CSE/ericsson.png"
                      />
                    </div>
                  </div>
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                  ...
                  <div className="col-4 col-sm-4 col-md-2	col-lg-2 col-xl-2">
                    <div className="picture">
                      <img
                        className="img-fluid"
                        src="assets/images/CSE/trident.png"
                      />
                    </div>
                  </div>
